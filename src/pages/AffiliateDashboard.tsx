...
// Define the system's blue color as a constant
const SYSTEM_BLUE = '#6366F1';
const SYSTEM_BLUE_DARK = '#4F46E5';
...
const StyledButton = styled(Button)(({ theme }) => ({
  ...
  fontWeight: 'bold',
  '&:hover': {
    backgroundColor: SYSTEM_BLUE_DARK,
  },
}));
      ...
      <Grid container spacing={3} sx={{ mb: 4 }}>
        ...
        <Grid item xs={12} sm={6} md={3}>
          <StyledCard>
            <CardContent sx={{ textAlign: 'center' }}>
              <IconWrapper sx={{ margin: '0 auto' }}>
                <TrendingUpIcon sx={{ fontSize: 30, color: SYSTEM_BLUE }} />
              </IconWrapper>
              <Typography variant="h5" component="div" sx={{ mb: 1 }}>
                50%
              </Typography>
        ...
        <Grid item xs={12} sm={6} md={3}>
          <StyledCard>
            <CardContent sx={{ textAlign: 'center' }}>
              <IconWrapper sx={{ margin: '0 auto' }}>
                <AccountBalanceWalletIcon sx={{ fontSize: 30, color: SYSTEM_BLUE }} />
              </IconWrapper>
              <Typography variant="h5" component="div" sx={{ mb: 1 }}>
                ₱5,200
              </Typography>
      ...
      <Paper elevation={3} sx={{ p: 3, mb: 4, borderRadius: '10px' }}>
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap', gap: 2 }}>
          ...
          <Box sx={{ display: 'flex', gap: 1 }}>
            <IconButton color="primary" sx={{ backgroundColor: 'rgba(255, 255, 255, 0.1)', color: SYSTEM_BLUE }}>
              <FacebookIcon />
            </IconButton>
            <IconButton color="primary" sx={{ backgroundColor: 'rgba(255, 255, 255, 0.1)', color: SYSTEM_BLUE }}>
              <WhatsAppIcon />
      ...
      <Paper elevation={3} sx={{ mb: 4, backgroundColor: '#1a1a2e', borderRadius: '10px' }}>
        <Tabs
          ...
          sx={{
            ...
            '& .Mui-selected': { color: SYSTEM_BLUE },
            '& .MuiTabs-indicator': { backgroundColor: SYSTEM_BLUE },
          }}
        >
          <Tab label="Overview" />
          <Tab label="Referrals" />
              ...
              <Paper sx={{ p: 2, height: 300, backgroundColor: '#0f0f1e' }}>
                <ResponsiveContainer width="100%" height="100%">
                  ...
                  >
                    ...
                    <Legend />
                    <Line type="monotone" dataKey="earnings" stroke={SYSTEM_BLUE} activeDot={{ r: 8 }} />
                  </LineChart>
                </ResponsiveContainer>
              </Paper>
            </Grid>
              ...
              <Paper sx={{ p: 2, height: 300, backgroundColor: '#0f0f1e' }}>
                <ResponsiveContainer width="100%" height="100%">
                  ...
                  >
                    ...
                    <Tooltip contentStyle={{ backgroundColor: '#222', border: 'none' }} />
                    <Legend />
                    <Bar dataKey="referrals" fill={SYSTEM_BLUE} />
                  </BarChart>
                </ResponsiveContainer>
              </Paper>
            </Grid>
