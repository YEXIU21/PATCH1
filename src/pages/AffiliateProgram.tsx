                  ...
                  <Box sx={{ mt: 3 }}>
                    ...
                    >
                      <Typography variant="body2" sx={{ color: 'white' }}>
                        Not an Affiliate yet? <Link to="/affiliate/register" style={{ color: SYSTEM_BLUE }}>Sign Up</Link>
                      </Typography>
                      <Typography variant="body2" sx={{ color: 'white' }}>
                        <Link to="/affiliate/forgot-password" style={{ color: SYSTEM_BLUE }}>Forgot Password?</Link>
                      </Typography>
                    </Box>
                  </Box>
                </form>
